/*
 * Quality mapping from SickRage to BTN's announce channel
 ...
 * - This is how Middleman decides if a release trumps another or not.
 *
...
module.exports = {
	...
	'sddvd': {
		'display': 'SDDVD',
		'sickname': 'sd dvd',
		'source': 'dvdrip|bdrip|bluray',
		'resolution': 'sd'
	},
	'sdtv': {
		'display': 'SDTV',
		'sickname': 'sd tv',
		'source': 'pdtv|hdtv|dsr|tvrip|web-dl|webrip',
		'resolution': 'sd'
	}
};

...
var loginUrl = 'https://passthepopcorn.me/ajax.php?action=login';
var searchUrl = 'https://passthepopcorn.me/torrents.php?json=noredirect&searchstr=%s&order_by=relevance&order_way=descending';
var downloadUrl = 'https://passthepopcorn.me/torrents.php?action=download&id=%s';
...
PTPHttp.prototype.__login = function(full, callback) {
	...
	self.client.json(loginUrl, data, true, function(err, resp) {
